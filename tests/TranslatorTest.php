...
class TranslatorTest extends TestCase
{
    ...
    public function test_translation_simple_with_dot(): void
    {
    ...
    public function test_translation_variables_twice(): void
    {
    ...
    public function test_translation_variables_many(): void
    {
